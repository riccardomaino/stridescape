 ...
 * @property month The month when the walk took place (1 for January, 2 for February, etc.).
 * @property steps The number of steps taken during the walk.
 * @property distance The total distance covered during the walk in meters.
 * @property time The duration of the walk in milliseconds.
 * @property calories The number of calories burned during the walk.
 * @property averageSpeed The average speed during the walk in kilometers per hour.
 */
