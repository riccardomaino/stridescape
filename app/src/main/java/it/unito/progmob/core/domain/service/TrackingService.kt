...
class TrackingService : Service() {
     ...
     */
    private var trackingServiceScope = CoroutineScope(SupervisorJob() + Dispatchers.IO)
    ...
    private fun updateWalkingSteps(stepsValue: Int) {
        if (initialSteps == 0){
